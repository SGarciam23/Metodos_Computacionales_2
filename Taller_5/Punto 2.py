# Este script resuelve el sistema determinista pedido en el punto 2.a y guarda la figura en 2.a.pdf
...
def RK2_U (A, lambdau, U_0, T, dt, n_traj):
    ...
    sigmamu = lambda U: np.sqrt(np.maximum(mu(U),0.0))
...
plt.plot(sol.t, sol.y[0], label='U sin ruido', color='black', linewidth=2)
plt.legend()
